...
/**
 * Holds the services this connector needs. The governance service is what gives the connector its own
 * per-organization configuration, and therefore its own presence in the Console.
 */
